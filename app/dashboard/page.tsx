      ...
      <main className="ml-0 md:ml-60">
        ...
        <div className="bg-white/70 backdrop-blur-xl border-b border-gray-200 pl-16 pr-4 md:px-6 py-3.5 flex items-center justify-between sticky top-0 z-20">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="/quotations" className="bg-blue-600 hover:bg-blue-700 text-white px-3 md:px-4 py-2 rounded-xl text-sm font-medium flex items-center gap-1.5 transition shadow-sm whitespace-nowrap">
              <Icon.plus className="w-4 h-4" /> <span className="hidden sm:inline">New Quotation</span><span className="sm:hidden">New</span>
            </a>
          </div>
        </div>
            ...
            <>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-5">
                {[
                  ...
                  return (
                    <div key={i} className="rise bg-white rounded-2xl border border-gray-200 p-4 md:p-5 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              ...
              {/* Revenue Chart */}
              <div className="rise bg-white rounded-2xl border border-gray-200 p-4 md:p-6 shadow-sm mb-5" style={{ animationDelay: "0.3s" }}>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="font-semibold text-gray-900">Revenue Overview</h3>
                    <p className="text-xs text-gray-400">Last 6 months (paid invoices)</p>
                  </div>
                  <p className="text-lg md:text-2xl font-bold text-gray-900">AED {months.reduce((a, m) => a + m.value, 0).toFixed(2)}</p>
                </div>
                <div className="flex items-end justify-between gap-2 md:gap-3 h-44 px-1 md:px-2">
                  {months.map((m, i) => {
              ...
              <div className="rise bg-white rounded-2xl border border-gray-200 p-5 shadow-sm mt-4" style={{ animationDelay: "0.6s" }}>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a href="/quotations" className="bg-blue-600 text-white px-5 py-2 rounded-xl text-sm font-medium hover:bg-blue-700 transition text-center">+ New Quotation</a>
                  <a href="/invoices" className="bg-white border border-gray-300 text-gray-700 px-5 py-2 rounded-xl text-sm font-medium hover:bg-gray-50 transition text-center">+ New Invoice</a>
                  <a href="/customers" className="bg-white border border-gray-300 text-gray-700 px-5 py-2 rounded-xl text-sm font-medium hover:bg-gray-50 transition text-center">+ Add Customer</a>
                </div>
              </div>
            </>
          )}
